...
export const GlobalProvider = ({ children }) => {
    ...
    const url = 'https://react-shopping-cart-5461c.firebaseio.com/products.json'
    ...
    const fetchData = async () => {
        ...
        loadedData.forEach(productData => {
            state.products.push({
                id: productData['id'],
        ...
        // initialState.products = loadedData        
        console.log('LD ',state.products)
    }
